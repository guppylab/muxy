...
pane ends its session for all clients; if a program other than the shell is
running in the foreground, the user confirms once first. Background jobs alone
